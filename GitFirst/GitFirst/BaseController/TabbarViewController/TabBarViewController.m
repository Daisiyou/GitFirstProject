...
-(void)initTabBar
{
    self.tabbar = [[AnimateTabbarView alloc]initWithTitleArr:@[@"主页",@"产品",@"我的"] AndNormalImages:@[@"Image.bundle/Tabbar/tb_account1",@"tb_search1",@"tb_service1"] AndSelectedImages:@[@"Image.bundle/Tabbar/tb_account2",@"tb_search2",@"tb_service2"]];
